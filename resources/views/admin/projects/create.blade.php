                ...
                >
                    ...
                    <fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
                        ...
                        <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                            ...
                            <div class="col-span-full sm:col-span-3">
                                ...
                                <input 
                                type="text" 
                                class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900 form-control @error('title') is-invalid @enderror" 
                                id="title" 
                                name="title" 
                                value="{{ old('title')}}">
                            ...
                            <div class="col-span-full sm:col-span-3">
                                ...
                                <input 
                                type="text" 
                                class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900 form-control @error('author') is-invalid @enderror" 
                                id="author" 
                                name="author" 
                                value="{{ old('author')}}">
                            ...
                            <div class="col-span-full sm:col-span-3">
                                ...
                                <input 
                                type="date" 
                                class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900 form-control @error('creation_date') is-invalid @enderror" 
                                id="creation_date" 
                                name="creation_date" 
                            ...
                            <div class="col-span-full sm:col-span-3">
                                ...
                                <input 
                                type="date" 
                                class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900 form-control @error('last_update') is-invalid @enderror" 
                                id="last_update" 
                                name="last_update" 
                            ...
                            <div class="col-span-full sm:col-span-6">
                                ...
                                <input 
                                type="text" 
                                class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900 @error('collaborators') is-invalid @enderror" 
                    ...
                    <fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
                        ...
                        <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                            ...
                            <div class="col-span-full sm:col-span-6">
                                <label for="type" class="form-label"style="font-weight:700; font-size:20px">
                                    Type
                                </label>
                                <select 
                            ...
                            {{-- Tecnologia del progetto --}}
                             ...
                             <div class="col-span-full sm:col-span-6">
                                <label for="technology" class="form-label"style="font-weight:700; font-size:20px">
                                    Technologies
                                </label>
                            ...
                            <div class="flex justify-center ml-12 p-6 rounded-md shadow-sm dark:bg-gray-900">
